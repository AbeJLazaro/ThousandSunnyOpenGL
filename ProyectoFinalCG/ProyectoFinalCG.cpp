/*
	Proyecto Final para la Materia de Computaci�n Gr�fica e Interacci�n Humano-Computadora
	Autores:		L�zaro Mart�nez Abraham Josu�
					Ian
					Apolo
	Fecha:			22/07/2021
	Versi�n:		1.2
...
// Tama�o en pixeles de la ventana
const unsigned int SCR_WIDTH = 1024;
const unsigned int SCR_HEIGHT = 768;

// Definici�n de c�mara (posici�n en XYZ)
Camera camera(glm::vec3(0.0f, 20.0f, 70.0f));

// Definici�n de proyeccion y vista
// Proyecci�n y vista
glm::mat4 projection;
glm::mat4 view;
...
// Variables para la velocidad de reproducci�n
// de la animaci�n
...
bool Start() {
	...
	// Creaci�n de la ventana con GLFW
	...
	// Activaci�n de buffer de profundidad
	glEnable(GL_DEPTH_TEST);

	// Inicializaci�n de las variables de fondo
	bgR = 0.54;
	bgG = 0.86;
	bgB = 1.0f;
	bgA = 1.0f;

	// Compilaci�n y enlace de shaders
	...
	// Carga la informaci�n de los modelos
...
// Carga y compilaci�n de los shaders
bool InicializacionShaders() {
...
void MaterialesSinTexturaUnaLuz() {
	// Activamos el shader est�tico
	materialSinTexturaUnaLuzShader->use();

	// Aplicamos transformaciones de proyecci�n y c�mara (si las hubiera)
...
void MaterialesAnimadosVariasLuces() {
	...
	if (elapsedTime > 1.0f / fps) {
		...
		// Configuraci�n de la pose en el instante t
...
bool Update() {
	...
	//			Objetos Sin textura con Iluminaci�n de Fresnel
...
// Funci�n para eliminar de memoria las mallas
void Limpiar() {
	delete Canons;
...
// glfw: Actualizamos el puerto de vista si hay cambios del tama�o
// de la ventana
void framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
